...
export default function Header() {
  ...
  return (
    <header className='flex justify-between p-3 items-center'>
      ...
      <nav className={`${menuOpen ? 'flex' : 'hidden'} gap-4 absolute top-16 left-1/2 -translate-x-1/2 flex-col items-center bg-white w-4/5 shadow-2xl rounded-lg py-6 px-4 z-10`}>
